-- return without ICU_READMISSION

DROP MATERIALIZED VIEW IF EXISTS mimiciii.demographics1 ;
CREATE MATERIALIZED VIEW mimiciii.demographics1 as
...
INNER JOIN mimiciii.getelixhauser_score2 eli
