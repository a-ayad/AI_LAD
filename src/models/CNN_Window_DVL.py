...
from tensorflow.keras.layers import Input, Flatten, Dense, Conv1D, concatenate, BatchNormalization, LeakyReLU, ReLU
from tensorflow.keras.models import Model


# CNN+FCN Model
def build(window_length, f1_threshold, learning_rate=0.01 , no_features_lab=25, num_classes=25, no_features_vitals=12, no_demo_features=3,
                CNN_kernal_size_11=1,
                CNN_kernal_size_12=1, CNN_kernal_size_21=2, CNN_kernal_size_22=4, CNN_nb_filters_1_1=100,
                CNN_nb_filters_1_2=100, CNN_nb_filters_1_3=100, CNN_nb_filters_2_1=100,
                CNN_nb_filters_2_2=50, CNN_nb_filters_2_3=200, dense_2_n=200, dense_3_n=200):
...
if __name__ == "__main__":
    ...
    model = build(window_length,f1_threshold,learning_rate=0.01)
